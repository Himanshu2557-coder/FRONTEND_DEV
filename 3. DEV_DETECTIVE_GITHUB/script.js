...
input.value = "Himanshu2557-coder";
getUserData(url + "Himanshu2557-coder");

// Also update LinkedIn manually
const linkedin = get("linkedin");
if (linkedin) {
  linkedin.href = "https://www.linkedin.com/in/himanshu-saini-19143b323";
  linkedin.innerText = "Himanshu Saini";
}
